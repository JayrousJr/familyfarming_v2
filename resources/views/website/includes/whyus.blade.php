         ...
         <div class="row g-4">
             <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                 <div class="feature-item text-center border p-5">
                     ...
                     <p class="mb-0">We have a big team of expert engineers, do not worry about that.</p>
                 </div>
             </div>
             <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                 <div class="feature-item text-center border p-5">
                     ...
                     <a href="#" class="h4 d-block my-4">Fair Costs</a>
                     <p class="mb-0">Our Costs are fair and affordable and free estimates too.</p>
                 </div>
             </div>
             <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                 <div class="feature-item text-center border p-5">
                     ...
                     <p class="mb-0">We use quality materials in all our projects, no worries on that.</p>
                 </div>
             </div>
         </div>
     </div>
